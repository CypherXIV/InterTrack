...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['message'])) {
    ...
    if (!empty($message)) {
        ...
        $insertStmt = $pdo->prepare("INSERT INTO messages (chat_id, sender_id, message, sender_type) VALUES (?, ?, ?, 'admin')");
        $insertStmt->execute([$chatId, $adminId, $message]);
...
<body style="background-image: none; background-color: #ffffff;">
    <div id="chat-container">
        ...
        <form action="handle_chat_admin.php?chatId=<?php echo $chatId; ?>" method="post">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchMessages() {
                fetch('handle_chat_admin.php?chatId=' + chatId + '&action=fetchMessages')
